...
pub fn create_router(state: Arc<AppState>) -> Router {
    ...
    Router::new()
        ...
        .route("/admin/panel/users", get(routes::admin_panel::panel_list_users))
        .route("/admin/panel/channels", get(routes::admin_panel::panel_list_channels))
        .route("/admin/panel/reports", get(routes::admin_panel::panel_list_reports))
        .route("/admin/panel/reports/{id}/review", post(routes::admin_panel::panel_review_report))
        .route("/admin/panel/audit", get(routes::admin_panel::panel_audit_log))
        .route("/admin/panel/ban", post(routes::admin_panel::panel_ban_user))
        // ---- Admin panel auth (desktop-signing + TOTP) ----
        .route("/admin/auth/challenge", post(routes::admin_auth::challenge))
        .route("/admin/auth/signed", post(routes::admin_auth::signed))
        .route("/admin/auth/poll", post(routes::admin_auth::poll))
        .route("/admin/auth/totp/enroll-begin", post(routes::admin_auth::enroll_begin))
        .route("/admin/auth/totp", post(routes::admin_auth::totp_verify))
        .route("/admin/auth/logout", post(routes::admin_auth::logout))
        .route("/admin/auth/me", get(routes::admin_auth::me))
        .route("/admin/auth/token-login", post(routes::admin_auth::token_login))
